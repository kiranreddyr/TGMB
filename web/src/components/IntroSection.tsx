      ...
      <div className={styles.content}>
        ...
        <div className={styles.body}>
          <p>
            ...
            This portal renders a live, rotating globe with a glowing band across it &mdash; the set of places
            currently scoring high on a &ldquo;Melt Score&rdquo; computed from real hourly weather data. It moves
            west with the sun every day, and drifts north and south with the seasons.
          </p>
          <p>
